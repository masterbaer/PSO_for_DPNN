...
from sequential_learning.pruning_playground.model import NeuralNetwork, CombinedNeuralNetwork, LeNet, CombinedLeNet, \
    VGG, CustomBatchNorm, CombinedVGGCustomBatch
...
def combine_models_VGG(model0, model1, model2, model3, combined_model, first_layer_name="None", last_layer_name="classifier"):
...
if __name__ == '__main__':
    ...
    #print(acc)
    # 0.9972000122070312 valid loader
    # 0.8837000131607056 test loader (it works!)
    ...
    #for (lcname,layer_combined), (l0name,layer0) in zip(combined_model.named_modules(),model0.named_modules()):
    #    print(lcname)
    #    print(l0name)
    #    print("-----")
    #    print("-----")
    # looks good, the model is of similar size
