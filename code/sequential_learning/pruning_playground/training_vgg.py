...
from model import NeuralNetwork, LeNet, VGG
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), f"vgg11_{seed}.pt")

    torch.save(valid_loss_list, f'vgg11_loss_{seed}.pt')
    torch.save(valid_accuracy_list, f'vgg11_accuracy_{seed}.pt')

    # validation accuracy after 60 epochs: 0.8687999844551086