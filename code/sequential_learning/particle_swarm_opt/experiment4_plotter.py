...
def plot_particle_number_experiment():
    training_losses = torch.load("loss_per_particlenumber_1_to_20.pt")
    plt.plot(training_losses)
    plt.ylabel("training loss per particle")
    plt.show()
    plt.cla()
    # TODO plot what is needed, maybe split experiments in multiple small ones and merge here
