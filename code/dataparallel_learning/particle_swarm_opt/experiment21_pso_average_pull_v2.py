...
from parallel_PSO_average_pull_v2 import PSOAveragePullv2
...
if __name__ == '__main__':
    ...
    pso = PSOAveragePullv2(model=model, inertia_weight=0,
                 ...
                 comm=comm, social_weight=0.9, init_strat="equal")

    pso.optimize(evaluate=True, output1=f"experiment21_loss.pt",
                 output2=f"experiment21_accuracy.pt")
